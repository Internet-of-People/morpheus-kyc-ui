...
import 'package:morpheus_common/utils/schema_form/json_form_field.dart';
import 'package:morpheus_common/utils/schema_form/json_schema_ext.dart';
...
class SchemaDefinedFormContentState extends State<SchemaDefinedFormContent> {
  ...
  Widget _buildWidgetFormSchema(String name, JsonSchema schema, bool topLevel, JsonSchemaFormTree schemaTree) {
    ...
    if(
      ...
      final field = _buildText(name, schema, controller, _getTextInputType(schema));
            ...
            throw Exception('Not supported JsonSchema type: ${schema.type}, schema: $schema');
          }
        }
